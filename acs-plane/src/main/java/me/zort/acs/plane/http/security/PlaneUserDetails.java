...
@Getter
public class PlaneUserDetails implements UserDetails {
    private final User user;
    private final Credentials credentials;
    private final Collection<? extends GrantedAuthority> authorities;

    public PlaneUserDetails(User user, Credentials credentials, Collection<? extends GrantedAuthority> authorities) {
        this.user = user;
