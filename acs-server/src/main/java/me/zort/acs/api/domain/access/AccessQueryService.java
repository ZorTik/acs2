...
public interface AccessQueryService {
     ...
     *
     * @param queryFunction the function that performs the query, accepting an {@link AccessQueryable} and {@link Pageable}
     ...
     */
    <T> Page<T> performAggregatedQuery(BiFunction<AccessQueryable, Pageable, Page<T>> queryFunction, Pageable pageable);
}
